...
public class CmdAutoClimbCenter extends SequentialCommandGroup {

  public CmdAutoClimbCenter() {

    addCommands(
      new CmdPrintText("**** Auto Center with Climb ****"),
      ...
      //Back up to tower
      new CmdDriveToAbsolutePoint(-75.0, -65.0, 0.0, 0.25, true, 0.0), 
      new CmdDriveToAbsolutePoint(-115.0, -65.0, 0.0, 0.25, true, 0.0), 
      ...
      new CmdDriveStop(),
      new CmdPrintText("Auto Center with Climb Complete")
    );
  }
}
