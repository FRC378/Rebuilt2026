...
public class CmdAutoClimbRight extends SequentialCommandGroup {

  public CmdAutoClimbRight() {

    addCommands(
      new CmdPrintText("**** Auto Right with Climb ****"),
      ...
      new CmdDriveStop(),
      new CmdPrintText("Auto Right with Climb Complete")
    );
  }
}
